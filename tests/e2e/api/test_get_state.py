...
def test_get_state_without_session_cookie(api_client, api_header_with_key):

    response = api_client.get("/state/", headers=api_header_with_key)

    assert response.status_code == 400


def test_get_state(api_client, database, api_header_with_key, session_cookie_name):
    database.connect()
...
def test_get_state_not_found(api_client, api_header_with_key, session_cookie_name):
...
def test_get_state_invalid_uuid(api_client, api_header_with_key, session_cookie_name):
...
def test_get_state_not_the_audience_error(
